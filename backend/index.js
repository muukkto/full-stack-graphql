...
const resolvers = {
  ...
  Mutation: {
    ...
    editAuthor: async(root, args) => {
      found_author_index = authors.findIndex(author => author.name === args.name)

      if (found_author_index >= 0) {
        authors[found_author_index].born = args.setBornTo

        return authors[found_author_index]
      }
